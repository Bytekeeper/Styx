...
import org.fttbot.UnitUtility
import org.fttbot.behavior.Construction
import org.fttbot.behavior.Defending
...
class WorkerDefence(val base: PlayerUnit) : Task {
    override val utility: Double
        get() = UnitUtility.danger(base.board)
    ...
    override fun run(available: Resources): TaskResult {
        ...
        if (alreadyDefending.size > numWorkerDefenders) {
            ...
            return TaskResult(Resources(potentialWorkerDefenders.subList(0, numWorkerDefenders)), TaskStatus.SUCCESSFUL)
        }
        ...
        return TaskResult(Resources(newDefenders + alreadyDefending), TaskStatus.SUCCESSFUL)
    }
...
object GatherResources : Task {
    ...
    override fun run(available: Resources): TaskResult {
        ...
        return TaskResult(Resources(workerUnits))
    }
