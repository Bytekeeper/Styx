...
//
//    @Test
//    fun `2 Zergling vs 1 Zealot should loose slightly`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Zergling),
//                SimUnit.of(UnitType.Zerg_Zergling)
//        )
...
//        assertThat(probabilityToWin).isGreaterThan(0.35)
//    }
//
//    @Test
...
//
//    @Test
//    fun `10 Mutas vs 10 Marines and 3 Medics should lose hard`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
...
//
//    @Test
//    fun `7 Zerglings should lose vs 2 sieged tank`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Zergling),
//                SimUnit.of(UnitType.Zerg_Zergling),
//                SimUnit.of(UnitType.Zerg_Zergling),
...
//
//    @Test
//    fun `7 Mutas vs 8 Hydras should lose`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
...
//
//    @Test
//    fun `6 Muta vs 1 Bunker and SCV should lose slightly`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
...
//
//    @Test
//    fun `6 Muta vs 1 Bunker should win`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
...
//        val probabilityToWin = CombatEval.probabilityToWin(a, b)
//
//        assertThat(probabilityToWin).isGreaterThan(0.55)
//    }
//
//    @Test
//    fun `7 Muta vs 1 Bunker and 4 SCV should lose hard`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
//                SimUnit.of(UnitType.Zerg_Mutalisk),
...
//
//    @Test
//    fun `3 Scourge should attack 5 Muta`() {
//        val a = listOf(
//                SimUnit.of(UnitType.Zerg_Scourge),
//                SimUnit.of(UnitType.Zerg_Scourge),
//                SimUnit.of(UnitType.Zerg_Scourge)
